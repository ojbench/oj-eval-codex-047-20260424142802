...
class ACMOJClient:
    ...
    def submit_code(self, problem_id: int, code: str, language: str = "cpp") -> Optional[Dict]:
        """
        Submit raw source code to ACMOJ. For this problem, pass the C++ content that should be used as src.hpp.
        """
...
def main():
    ...
    # Direct source submission (for problems expecting a single source like src.hpp)
    submit_file_parser = subparsers.add_parser("submit-file", help="Submit a local source file")
    ...
    if args.command == "submit":
        ...
        try:
            ...
            return
        result = client.submit_code(args.problem_id, code, language="cpp")
